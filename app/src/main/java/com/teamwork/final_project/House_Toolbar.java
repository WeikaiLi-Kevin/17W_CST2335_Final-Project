...
public class House_Toolbar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.house_activity_house_toolbar);
    ...
    public boolean onOptionsItemSelected (MenuItem mi){
        switch(mi.getItemId()){
            case R.id.Icon_kitchen:
                Intent intent = new Intent(House_Toolbar.this, kitchen_main.class);
                startActivity(intent);
                break;

            case R.id.Icon_house:
                Intent intent1 = new Intent(House_Toolbar.this, HouseListView.class);
                startActivityForResult(intent1, 5);
                break;

            case R.id.Icon_automobile:
                Intent intnt = new Intent(House_Toolbar.this, AutomobileFragmentDetails.class);
            ...
            case R.id.Help:
                ...
                // Add the buttons
                builder.setMessage("House's author: Di Yuan\n\nVersion: 1.0.0\n\nInstruction of this interface: " +
